...
```shell
gcloud docker -- pull launcher.gcr.io/google/postgresql11
```

Dockerfile for this image can be found [here](https://github.com/GoogleCloudPlatform/postgresql-docker/tree/master/11).
...
docker run \
  ...
  -p 5432:5432 \
  -d \
  launcher.gcr.io/google/postgresql11
```
