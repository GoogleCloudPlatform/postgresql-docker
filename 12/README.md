...
This image contains an installation of PostgreSQL 12.x.

For more information, see the
[Official Image Launcher Page](https://console.cloud.google.com/launcher/details/google/postgresql12).

Pull command (first install [gcloud](https://cloud.google.com/sdk/downloads)):

```shell
gcloud docker -- pull launcher.gcr.io/google/postgresql12
```

Dockerfile for this image can be found [here](https://github.com/GoogleCloudPlatform/postgresql-docker/tree/master/12).
...
spec:
  containers:
    - image: launcher.gcr.io/google/postgresql12
      name: postgres
      env:
...
docker run \
  ...
  -p 5432:5432 \
  -d \
  launcher.gcr.io/google/postgresql12
```
